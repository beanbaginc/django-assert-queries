...
class ExpectedQuery(TypedDict):
    ...
    This is used for :py:meth:`django_assert_queries.testing.assert_queries`.
...
def _check_queries(
    *,
    ...
    :py:func:`~django_assert_queries.query_catcher.catch_queries` and compare
    them against a list of expected queries. The results are a list of
    mismatches found between the executed and expeceted queries.
    ...
    Args:
        ...
        catch_ctx (django_assert_queries.query_catcher.CatchQueriesContext):
