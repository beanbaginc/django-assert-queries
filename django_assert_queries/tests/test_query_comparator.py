"""Unit tests for django_assert_queries.query_comparator.
...
class CompareQueriesTests(TestCase):
    """Unit tests for django_assert_queries.query_comparator.compare_queries.
    ...
    def test_with_mismatch_joins(self) -> None:
        ...
        self.assertEqual(
            ...
            [
                ...
                {
                    'executed_value': 'Q(testmodel__pk__gt=0)',
                    'expected_value': 'Q()',
                    'name': 'where',
                    'raw_executed_value': Q(testmodel__pk__gt=0),
    ...
    def test_with_mismatch_select_related(self) -> None:
        ...
        with compare_queries(queries) as ctx:
            list(User.objects.select_related('testmodel'))
        ...
        self.assertEqual(
            ...
            [
                {
                    'executed_value': "{'testmodel'}",
                    'expected_value': "{'group'}",
                    'name': 'select_related',
                    'raw_executed_value': {'testmodel'},
...
class FormatNodeTests(TestCase):
    """Unit tests for django_assert_queries.query_comparator._format_node.
